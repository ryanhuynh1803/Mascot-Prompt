export const optionChoices = {
  ...
  costume_type: [
    ...
    "superhero suit", "traditional folk attire", "sports uniform", "wizard robes",
    "animal costume", "robot shell", "chef's uniform", "scientist's lab coat",
    "astronaut suit", "vintage outfit", "punk rock attire", "business suit"
  ],
  design_theme: [
  ...
  material_2: [
    ...
    "denim", "frosted glass", "textured rubber", "satin", "silk", "iridescent coating",
    "sandpaper texture", "liquid metal", "ceramic", "carbon fiber", "concrete", "crystal"
  ],
  material_3: [
    "smooth fabric", "glossy enamel", "soft-touch rubber", "distressed leather", "bamboo",
    "canvas", "stained glass", "foam", "corduroy", "lace", "reflective chrome",
    "embossed paper", "liquid mercury", "porcelain", "graphite", "marble", "gemstone"
  ],
  surface_feel: [
  ...
  lighting_style: [
    ...
    "neon glow from below", "cinematic rim lighting", "moody low key lighting",
    "vibrant volumetric lighting", "backlit silhouette", "dynamic spotlight",
    "diffused ambient light", "harsh direct sunlight", "magical glowing particles"
  ],
  background_type: [
    "clean white background", "minimalist gradient", "abstract geometric pattern",
